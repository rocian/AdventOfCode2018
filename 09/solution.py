...
def part_one(nplayer, nmarble):
    players = np.zeros(nplayer)
    mylist = circular()
    m = 0
    mylist.add(m)
    mm = 1
    ...
    return winner, int(wscore)


nplayers, nmarbles = read_input()
win1, wsc1 = part_one(nplayers, nmarbles)
win2, wsc2 = part_one(nplayers, nmarbles * 100)

print("\n--- Day 09 ---")
print("part 1: answer to part one = {}".format(wsc1))
print("part 2: answer to part two = {}".format(wsc2))
print("--------------\n")

# --- Day 09 ---
# part 1: answer to part one = 367802
# part 2: answer to part two = 2996043280
# --------------
#
# 0 11:18  Sun Dec  9 11:18 CET 2018
# 1 09:41  Mon Dec 10 09:41 CET 2018
# position 7343    923
# 2 11:12  Tue Dec 11 11:12 CET 2018
# position 8807    814
